...
export function DisplayAttachment({ type, name, size, href }: AttachmentProps) {
  ...
  return (
    <div
      ...
      className="flex items-center justify-between w-[310px] max-w-full gap-8 bg-white border rounded-[8px] p-[12px]"
    >
      <div className="flex items-center gap-2">
        ...
        <div className="details w-[calc(100px)] flex flex-col mt-[-6px]  ">
          <Link
            href={href}
            target="_blank"
            className=" text-[#101828] text-[14px] leading-[20px] font-[600]  w-fit max-w-full truncate hover:underline "
          >
            {name}
          </Link>
      ...
      <div
        className="download-btn transition-all   hover:text-white cursor-pointer text-primary-normal     flex justify-center items-center"
