...
export default function ExpertArea({ NoteExpert, noteSlug }: Props) {
  ...
  return (
    ...
    <div className="expert hidden text-[#1E293B] flex items-end justify-between  mt-4 w-full py-6 px-6 border rounded-[4px] toHide">
      ...
      <div className="audio-player h-[180px] w-[300px] rounded-[5px] overflow-hidden">
        ...
        <AudioPlayer
          ...
          withControl
        />
        {/* <audio controls src={FullPath("/note/audio/" + NoteExpert?.audioSrc)}></audio> */}
      </div>
    </div>
  );
}
